 ...
 * @param {string} [props.userLabel] — e.g. name or email for context
 */
          ...
          >
            ...
            <div className="mt-6 flex flex-wrap items-center justify-end gap-2">
              <button
                ...
                onClick={onClose}
                disabled={isDeleting}
                className="rounded-xl border border-slate-200 bg-white px-4 py-2.5 text-sm font-semibold text-slate-700 transition hover:bg-slate-50 disabled:opacity-50 dark:border-zinc-600 dark:bg-zinc-800 dark:text-slate-200 dark:hover:bg-zinc-700"
              >
                {t("users.cancel")}
              </button>
              <button
                ...
                onClick={onConfirm}
                disabled={isDeleting}
                className="inline-flex items-center justify-center gap-2 rounded-xl bg-red-600 px-4 py-2.5 text-sm font-semibold text-white transition hover:bg-red-700 disabled:opacity-60 dark:bg-red-700 dark:hover:bg-red-600"
              >
                {isDeleting ? (
